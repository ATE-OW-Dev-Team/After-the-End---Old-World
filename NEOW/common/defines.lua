...
NCharacter = {
	...
	NATURAL_DEATH_CHANCE_AGE_0 = 90,				-- Natural deaths per decade out of 10000 people: Age 0-9
	...
	NATURAL_DEATH_CHANCE_AGE_70 = 1900,				-- Natural deaths per decade out of 10000 people: Age 70-79
...
NEngine = {
	EVENT_PROCESS_OFFSET = 175, 	 -- Events are checked every X day per character or province (1 is ideal, but CPU heavy). Max value of 255
