...
NMilitary = {
	...
	ATTACKER_SIEGE_DAMAGE = 0.5,						-- Siege attack values are multiplied by this value(when not doing a sally), for attackers
	DEFENDER_SIEGE_DAMAGE = 0.05,						-- Siege attack values are multiplied by this value(when not doing a sally), for defenders
