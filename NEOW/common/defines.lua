...
NEngine = {
	...
	COURTIER_EVENT_PROCESS_OFFSET = 115, 	 -- Events are checked every X day for courtiers. Max value of 255
...
NAI =
{
	...
	RAID_MAX_REALM_SIZE = 30,								-- Realms with more holdings than this will never go on Raids
