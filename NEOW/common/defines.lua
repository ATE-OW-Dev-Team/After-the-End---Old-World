...
NReligion = {
	...
	REFORM_RELIGION_MIN_AUTHORITY = 0.6,			-- Moral authority required to reform a pagan faith
...
NMilitary = {
	...
	ATTACKER_SIEGE_DAMAGE = 0.425,						-- Siege attack values are multiplied by this value(when not doing a sally), for attackers
	DEFENDER_SIEGE_DAMAGE = 0.2,						-- Siege attack values are multiplied by this value(when not doing a sally), for defenders
